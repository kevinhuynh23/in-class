...
p.innerHTML = '<strong>This is my parapgraph</strong';
...
document.querySelector(".container")
    .insertBefore(button, svgWrapper);
...
function updateText(data) {
    ...
    text.innerHTML = `There are ${data.length} circles on this page and the avergea color
    is rgb(0, ${green}, ${blue}).`
}
