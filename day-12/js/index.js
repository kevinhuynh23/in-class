...
class Puppy {
    ...
    constructor(img="https://cdn1-www.dogtime.com/assets/uploads/2010/12/puppies.jpg", sound="bark") {
        this.img = img;
        this.sound = sound;
    }
    ...
    render() {
        let puppyCard = $('<div>');
        puppyCard.attr('title', `puupy that says ${this.sound}`);
...
class PuppyApp {
    ...
    render() {
        ...
        this.puppyCard.append(`img src=${this.img}`)
